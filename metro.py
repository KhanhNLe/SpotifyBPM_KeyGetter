...
class MetronomeApp:
    ...
    def create_widgets(self):
        ...
        self.track_name_label = ttk.Label(self.root, text="Track: ")
    ...
    def run_metronome(self):
        if self.is_running:
            ...
            interval = 60 / bpm
            self.root.after(int(interval * 1000), self.run_metronome)
    ...
    def fetch_currently_playing_track(self):
        ...
        self.root.after(1000, self.fetch_currently_playing_track)  # Check every 5 seconds
...
if __name__ == "__main__":
    ...
    app.fetch_currently_playing_track()  # Start the dynamic checker
    root.mainloop()
